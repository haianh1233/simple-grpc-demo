...
public final class CalculatorServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.haianh.calculator.Input,
      com.haianh.calculator.Output> getFindFactorialMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "findFactorial",
      requestType = com.haianh.calculator.Input.class,
      responseType = com.haianh.calculator.Output.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.haianh.calculator.Input,
      com.haianh.calculator.Output> getFindFactorialMethod() {
    io.grpc.MethodDescriptor<com.haianh.calculator.Input, com.haianh.calculator.Output> getFindFactorialMethod;
      ...
      synchronized (CalculatorServiceGrpc.class) {
        if ((getFindFactorialMethod = CalculatorServiceGrpc.getFindFactorialMethod) == null) {
          CalculatorServiceGrpc.getFindFactorialMethod = getFindFactorialMethod = 
              io.grpc.MethodDescriptor.<com.haianh.calculator.Input, com.haianh.calculator.Output>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "calculator.CalculatorService", "findFactorial"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.haianh.calculator.Input.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.haianh.calculator.Output.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.haianh.calculator.Input,
      com.haianh.calculator.Output> getGetAllDoublesMethod;
  ...
  public static io.grpc.MethodDescriptor<com.haianh.calculator.Input,
      com.haianh.calculator.Output> getGetAllDoublesMethod() {
    io.grpc.MethodDescriptor<com.haianh.calculator.Input, com.haianh.calculator.Output> getGetAllDoublesMethod;
  ...
  private static volatile io.grpc.MethodDescriptor<com.haianh.calculator.Input,
      com.haianh.calculator.Output> getSumAllMethod;
  ...
  public static io.grpc.MethodDescriptor<com.haianh.calculator.Input,
      com.haianh.calculator.Output> getSumAllMethod() {
    io.grpc.MethodDescriptor<com.haianh.calculator.Input, com.haianh.calculator.Output> getSumAllMethod;
  ...
  private static volatile io.grpc.MethodDescriptor<com.haianh.calculator.Input,
      com.haianh.calculator.Output> getPlayUpTo100Method;
  ...
  public static io.grpc.MethodDescriptor<com.haianh.calculator.Input,
      com.haianh.calculator.Output> getPlayUpTo100Method() {
    io.grpc.MethodDescriptor<com.haianh.calculator.Input, com.haianh.calculator.Output> getPlayUpTo100Method;
  ...
  public static abstract class CalculatorServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void findFactorial(com.haianh.calculator.Input request,
        io.grpc.stub.StreamObserver<com.haianh.calculator.Output> responseObserver) {
     ...
     * </pre>
     */
    public void getAllDoubles(com.haianh.calculator.Input request,
        io.grpc.stub.StreamObserver<com.haianh.calculator.Output> responseObserver) {
     ...
     * </pre>
     */
    public io.grpc.stub.StreamObserver<com.haianh.calculator.Input> sumAll(
        io.grpc.stub.StreamObserver<com.haianh.calculator.Output> responseObserver) {
     ...
     * </pre>
     */
    public io.grpc.stub.StreamObserver<com.haianh.calculator.Input> playUpTo100(
        io.grpc.stub.StreamObserver<com.haianh.calculator.Output> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.haianh.calculator.Input,
                com.haianh.calculator.Output>(
  ...
  public static final class CalculatorServiceBlockingStub extends io.grpc.stub.AbstractStub<CalculatorServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.haianh.calculator.Output findFactorial(com.haianh.calculator.Input request) {
     ...
     * </pre>
     */
    public java.util.Iterator<com.haianh.calculator.Output> getAllDoubles(
        com.haianh.calculator.Input request) {
  ...
  public static final class CalculatorServiceFutureStub extends io.grpc.stub.AbstractStub<CalculatorServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.haianh.calculator.Output> findFactorial(
        com.haianh.calculator.Input request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_FIND_FACTORIAL:
          serviceImpl.findFactorial((com.haianh.calculator.Input) request,
              (io.grpc.stub.StreamObserver<com.haianh.calculator.Output>) responseObserver);
          break;
        case METHODID_GET_ALL_DOUBLES:
          serviceImpl.getAllDoubles((com.haianh.calculator.Input) request,
              (io.grpc.stub.StreamObserver<com.haianh.calculator.Output>) responseObserver);
          break;
        default:
  ...
  private static abstract class CalculatorServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.haianh.calculator.Calculator.getDescriptor();
    }
